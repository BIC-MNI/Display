...
\psfigure{display.ps}{7in}{Clockwise from top left:
3D window, slice window, menu window, text entry window.}{windows}
...
\item[\menutwo{Slice}{Reset Slice View}]  Resets the view of the slice
       to which the mouse is pointing to fill the viewport.
\item[\menutwo{Slice}{Box Filter Volume}]  Prompts the user to type in
