...
In the object  window, the following mouse operations are available:
...
magnification of object in the 3D view window. It also has some experimental features related to 3D rendering.
