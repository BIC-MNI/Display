...
\title{{\bf MNI-Display} - Global configuration variables. }
...
the program.  program itself. These globals serve a wide range of
...
\section{Setting globals in a configuration file}
...
\section{Setting globals on the command line}
...
\section{Setting globals with a menu command}
...
\section{List of useful globals}

\newcommand{\globalentry}[5]{\subsection{{\tt #1}}
\paragraph{Type}{#2}%
...
\section{List of developer globals}
...
\globalentry{Interval\_of\_check} {Integer}{250}
...
\globalentry{Max\_background\_seconds}{Real}{0.2}
{Controls the maximum amount of time certain ``background'' operations may run before they are interrupted.}{}

\globalentry{Maximum\_display\_time} {Real}{0.3} 
