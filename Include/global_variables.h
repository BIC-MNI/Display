START_GLOBALS
    ...
    DEF_GLOBAL( Readout_text_colour, int, 0 )
    ...
    DEF_GLOBAL_STRING( Slice_probe_voxel_format, "" )
    DEF_GLOBAL_STRING( Slice_probe_val_format, "" )
    DEF_GLOBAL_STRING( Slice_probe_label_format, "" )
    ...
    DEF_GLOBAL( Cursor_colour, Colour, BLUE )
    DEF_GLOBAL( Show_cursor_contours, Boolean, FALSE )
    DEF_GLOBAL( Cursor_contour_thickness, int, 2 )
    DEF_GLOBAL( Cursor_colour_on_surface, Colour, RED )
    DEF_GLOBAL( Cursor_colour_off_surface, Colour, BLUE )
    ...
    DEF_GLOBAL( Initial_display_labels, Boolean, FALSE )
