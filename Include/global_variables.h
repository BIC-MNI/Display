START_GLOBALS
    ...
    DEF_GLOBAL_STRING( Slice_probe_x_voxel_format, "X voxel = %6.1f" )
    DEF_GLOBAL_STRING( Slice_probe_y_voxel_format, "Y voxel = %6.1f" )
    DEF_GLOBAL_STRING( Slice_probe_z_voxel_format, "Z voxel = %6.1f" )
    DEF_GLOBAL_STRING( Slice_probe_x_world_format, "X world = %6.1f mm" )
    DEF_GLOBAL_STRING( Slice_probe_y_world_format, "Y world = %6.1f mm" )
    DEF_GLOBAL_STRING( Slice_probe_z_world_format, "Z world = %6.1f mm" )
    DEF_GLOBAL_STRING( Slice_probe_voxel_format,   "Voxel   = %4g" )
    DEF_GLOBAL_STRING( Slice_probe_val_format,     "Value   = %4g" )
    DEF_GLOBAL_STRING( Slice_probe_label_format,   "Label   = %4d" )
    DEF_GLOBAL( Probe_x_pos, int, 100 )
    ...
    DEF_GLOBAL( Cursor_hor_end_0, Real, 30.0 )
    DEF_GLOBAL( Cursor_vert_start_0, Real, 3.0 )
    DEF_GLOBAL( Cursor_vert_end_0, Real, 30.0 )

    DEF_GLOBAL( Cursor_hor_start_1, Real, 3.0 )
    DEF_GLOBAL( Cursor_hor_end_1, Real, 30.0 )
    DEF_GLOBAL( Cursor_vert_start_1, Real, 3.0 )
    DEF_GLOBAL( Cursor_vert_end_1, Real, 30.0 )

    DEF_GLOBAL( Cursor_hor_start_2, Real, 3.0 )
    DEF_GLOBAL( Cursor_hor_end_2, Real, 10.0 )
    DEF_GLOBAL( Cursor_vert_start_2, Real, 3.0 )
    DEF_GLOBAL( Cursor_vert_end_2, Real, 10.0 )
    ...
    DEF_GLOBAL( Colour_bar_width, Real, 20.0 )
