START_GLOBALS
    ...
    DEF_GLOBAL_STRING( Slice_index_x_locked_format, "Fixed X = %8g" )
    DEF_GLOBAL_STRING( Slice_index_y_locked_format, "Fixed Y = %8g" )
    DEF_GLOBAL_STRING( Slice_index_z_locked_format, "Fixed Z = %8g" )
    ...
    DEF_GLOBAL( Cursor_end_pixel_x, int, 30 )
