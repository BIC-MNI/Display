    ...
    graphics_struct   *graphics;
{
    ...
    graphics->slice.slice_views[0].axis_index = Top_left_index;
    graphics->slice.slice_views[1].axis_index = Top_right_index;
    graphics->slice.slice_views[2].axis_index = Bottom_left_index;
